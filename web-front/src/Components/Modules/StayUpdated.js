    ...
    return <MainContainer>
        <BasicContainer variant="primary">
            ...
            <ContainerCenter marginTop="18px" marginRight="20px">
                <a href="https://discord.gg/rsyehn5bX3" target="_blank"><CustomSizeImage src="https://downbelow-assets.s3.us-east-2.amazonaws.com/Assets/Icons/Socials/Discord_large.png" width="104px" height="104px"/></a>
